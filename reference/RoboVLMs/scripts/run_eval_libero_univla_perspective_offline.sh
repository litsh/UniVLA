...
ckpt_dir=${ckpt_dir:-"/inspire/hdd/project/socialsimulation/chenfangke-253108540237/tsli/UniVLA/logs/gripper_WEIGHTED_VC=1.0---VS=0.1---AC=0.0---AS=0.0/checkpoint-1000"}
DATASET_ROOT=${DATASET_ROOT:-"/inspire/hdd/project/socialsimulation/chenfangke-253108540237/tsli/UniVLA/logs/libero/offline_perspective_evalset/libero_object-2026-03-22_10-28-16/object_eval_set"}
OUTPUT_DIR=${OUTPUT_DIR:-"/inspire/hdd/project/socialsimulation/chenfangke-253108540237/tsli/UniVLA/logs/libero/offline_perspective_metrics/checkpoint-1000/object"}
